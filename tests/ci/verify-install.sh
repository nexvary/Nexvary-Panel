...
for file in panel/__init__.py panel/module_registry.py panel/routes_accounts.py panel/account_schema.py panel/routes_mail.py panel/mail_schema.py panel/routes_transfers.py panel/transfer_schema.py panel/routes_domains.py panel/domain_schema.py panel/routes_advanced_ops.py panel/routes_autossl.py panel/routes_deliverability.py panel/routes_wordpress_lifecycle.py panel/wordpress_client.py panel/ops_schema.py panel/ops_client.py static/app.css static/approved-theme.css static/hosting-suite.css static/accounts.css static/accounts.js static/mail.css static/mail.js static/transfers.css static/transfers.js static/advanced-ops.css static/advanced-ops.js static/webtools.css static/webtools.js static/scheduled-tasks.css static/wordpress-lifecycle.js panel/hosting_features.py; do
  test -f "/opt/nexvary-panel/$file"
done
for file in secret_vault.py vault_agent.py provider_agent.py webtools.py domain_ops.py webtools_agent.py scheduler_agent.py autossl_scheduler.py mail_agent.py mail_backend.py transfer_agent.py hosting_ops_agent.py hosting_ops_entry.py postgres_agent.py wordpress_agent.py; do
