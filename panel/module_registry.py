...
MODULES: tuple[PanelModule, ...] = (
    ...
    PanelModule("fleet", "Fleet Orchestration", "server", register_fleet_routes, depends_on=("advanced_ops",), feature_prefixes=("whm.fleet",), provider_services=("nexvary-panel-provider",), ui_view="advancedops", maturity="provider", endpoint_namespace="fleet"),
