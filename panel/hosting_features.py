...
_FEATURES: tuple[HostingFeature, ...] = (
    ...
    HostingFeature("databases.postgresql", "databases", "PostgreSQL Databases", "account", "foundation", provider="postgresql"),
    ...
    HostingFeature("whm.server_time", "server", "Server Time", "server", "foundation", risk="privileged"),
    ...
    HostingFeature("whm.multi_account", "accounts", "Multi-Account Functions", "server", "foundation", risk="privileged"),
    HostingFeature("whm.transfers", "accounts", "Account Transfers", "server", "foundation", risk="privileged"),
    ...
    HostingFeature("whm.ip_functions", "networking", "IP Functions", "server", "foundation", risk="privileged"),
    ...
    HostingFeature("whm.mail_queue", "email", "Mail Queue", "server", "foundation", risk="privileged", provider="mail"),
    ...
    HostingFeature("whm.api_tokens", "security", "Server API Tokens", "server", "foundation", risk="privileged"),
